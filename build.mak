export PJDIR := /Users/shrey/Dev/pjproject
...
export TARGET_ARCH := 
export STD_CPP_LIB := 
export TARGET_NAME := x86_64-apple-darwin21.6.0
...
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-I/include -O2 -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-L/lib -lm -lpthread  -framework CoreAudio -framework CoreServices -framework AudioUnit -framework AudioToolbox -framework Foundation -framework AppKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -framework VideoToolbox 
...
export PJ_INSTALL_LDFLAGS_PRIVATE := $(APP_THIRD_PARTY_LIBS) $(APP_THIRD_PARTY_EXT) -L/lib -lm -lpthread  -framework CoreAudio -framework CoreServices -framework AudioUnit -framework AudioToolbox -framework Foundation -framework AppKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -framework VideoToolbox 
